...
from heart_n_thoughts.utils import (_check_subject_index, _look_up_group,
                                    insert_groups)
from heart_n_thoughts.tests import get_test_data_path

test_data_dir = get_test_data_path()
df_noidx = pd.read_csv(test_data_dir / "test_probes.tsv",
                          sep="\t")
df_idx = pd.read_csv(test_data_dir / "test_probes.tsv",
                        sep="\t", index_col=0)
